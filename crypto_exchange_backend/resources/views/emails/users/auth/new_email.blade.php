...
@section('content')
    ...
    <tr>
        <td style="font: 14px Poppins; padding-top: 24px; padding-bottom: 16px; font-weight: 400; line-height: 22px;">
            @lang('email_texts.new_email_1')
        </td>
    </tr>
    <tr>
        <td style="font: 14px Poppins; padding-top: 24px; padding-bottom: 56px; font-weight: 400; line-height: 22px;">
            <a href="{{ $confirmationUrl }}" style="color: #3EB678; text-decoration: none;">
                Reset email link
            </a>
        </td>
    </tr>
    <tr>
        <td style="font: 14px Poppins; border-top: 1px solid #E0E0E0; padding-top: 24px; font-weight: 400; line-height: 22px;">@lang('email_texts.new_email_2') <br><br>@lang('email_texts.thank_you')</td>
    </tr>
@endsection
