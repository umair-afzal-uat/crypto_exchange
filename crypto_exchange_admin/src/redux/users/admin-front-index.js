jQuery(document).ready(function($) {
	$(document).on('click','.wie_download_pdf',function() {
		...
		var paper_size_class = 'paper_size-a3';
		var paper_orientation_class = 'paper_orientation-'+design_map.paper.orientation;

		var outline_add = 'a3-'+design_map.paper.orientation+'-'+design_map.layer.outline.type;
		...
		if(design_map.poster.style == 'pastel') {
			...
			elevation_color = 'rgba(249, 243, 229, 0.8)';
		}
	    ...
	    var source;
	    let eleToAdd = [ 'layer', 'elevation', elevation_class_multiply];
	    ...
	    let mapToAdd = [ 'layer', 'map', design_map.paper.orientation];
	    map_create.classList.add(...mapToAdd);
	    map_create.id = 'map-layer';
	    // map_create.style.width = width;
     // 	map_create.style.height = height;
	    ...
	    let outlineToAdd = [ 'layer', 'outline', outline_add];
		...
		let canvas_title_to_add = [ 'canvas_title', font_class_family, font_class_size, paper_orientation_class ,paper_size_class];
		...
		let canvas_bottom_to_add = [ 'bottom-content', font_class_family, font_class_size, paper_orientation_class ,paper_size_class];
		...
		renderMap.once('idle', function() {
			html2canvas(document.querySelector('.canvas_image')).then(function(canvas) {
