...
const NumberInput = ({ label, ...props }) => {
   ...
   const getNumberValue = (e) => {
       let countrycode = document.getElementById("cars").value;
  ...
  >
    <label>
      ...
      <div className="input-wrapper countrySelect_field">
        <select name="cars" id="cars" onChange={getNumberValue}>zq
        <option data-countryCode="US" selected value="1">
            USA (+1)
          </option>
